...
def test_begin_composite_node_run_accepts() -> None:
    ...
    candidate_set = make_candidate_set(candidate=NodeTypeRef(node_type_id="jarvis.core.echo", version="0.3.8"))
    ...
    request = CompositeExecutorBeginCompositeNodeRunRequest(
        body=CompositeBeginRequest(
            ...
            node_type_ref=NodeTypeRef(node_type_id="jarvis.composite.planner", version="0.3.8"),
            inputs={"goal": "test"},
